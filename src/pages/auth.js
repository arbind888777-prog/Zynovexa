  ...
  <div class="min-h-screen flex">
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-8">
      <div class="w-full max-w-md">
        ...
        <div class="mb-6 rounded-2xl border border-blue-100 bg-blue-50 p-4 text-sm text-gray-700">
          <div class="flex items-start gap-3">
            <div class="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 text-brand-600">
              <i class="fas fa-shield-halved text-sm"></i>
            </div>
            <div>
              <p class="font-semibold text-gray-900">Public legal links for account and API review</p>
              <p class="mt-1 leading-6 text-gray-600">Before using Zynovexa, you can review our <a href="/privacy" class="font-semibold text-brand-600 hover:underline">Privacy Policy</a>, <a href="/terms" class="font-semibold text-brand-600 hover:underline">Terms of Service</a>, and <a href="/data-deletion" class="font-semibold text-brand-600 hover:underline">Data Deletion Instructions</a>.</p>
            </div>
          </div>
        </div>
        ...
        <form id="auth-form" onsubmit="handleSubmit(event)" class="space-y-4">
          ...
          <p class="rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-xs leading-6 text-gray-500">
            ${isLogin
        ? 'By signing in, you acknowledge that your use of Zynovexa is governed by our <a href="/terms" class="font-semibold text-brand-600 hover:underline">Terms of Service</a> and <a href="/privacy" class="font-semibold text-brand-600 hover:underline">Privacy Policy</a>.'
        : 'By creating an account, you agree to the <a href="/terms" class="font-semibold text-brand-600 hover:underline">Terms of Service</a> and confirm that you have reviewed the <a href="/privacy" class="font-semibold text-brand-600 hover:underline">Privacy Policy</a>.'}
          </p>
        </form>
        ...
        <div class="mt-6 flex flex-wrap items-center justify-center gap-4 text-xs text-gray-500">
          <a href="/privacy" class="font-semibold hover:text-gray-700">Privacy Policy</a>
          <span class="text-gray-300">•</span>
          <a href="/terms" class="font-semibold hover:text-gray-700">Terms of Service</a>
          <span class="text-gray-300">•</span>
          <a href="/data-deletion" class="font-semibold hover:text-gray-700">Data Deletion</a>
          <span class="text-gray-300">•</span>
          <a href="/about" class="font-semibold hover:text-gray-700">About</a>
        </div>
      </div>
    </div>
  </div>
