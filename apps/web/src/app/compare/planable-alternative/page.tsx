...
const PRICING = [
  { plan: 'Free', zynovexa: '$0/mo — 5 posts/month, 2 platforms, 20 AI credits', competitor: '$0/mo — 50 total posts only' },
  { plan: 'Starter', zynovexa: '$5/mo — 30 posts/month, 3 platforms, 100 AI credits', competitor: '$33/mo per workspace — scheduling only' },
  { plan: 'Growth', zynovexa: '$19/mo — Unlimited posts, unlimited AI, teams', competitor: '$83/mo per workspace — approval workflows' },
];
