...
const PRICING = [
  { plan: 'Free', zynovexa: '$0/mo — Unlimited posts, 3 accounts, 50 AI credits', competitor: '$0/mo — 10 scheduled posts per channel, 3 channels' },
  { plan: 'Pro', zynovexa: '$19/mo — 10 accounts, 500 AI credits, full analytics', competitor: '$6/mo per channel — Basic scheduling, no AI' },
  { plan: 'Business', zynovexa: '$49/mo — 25 accounts, unlimited AI, team features', competitor: '$120/mo — 10 channels, limited team features' },
];
