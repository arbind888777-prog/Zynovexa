...
const PRICING = [
  { plan: 'Free', zynovexa: '$0/mo — Unlimited posts, 3 accounts, 50 AI credits', competitor: 'No free plan available' },
  { plan: 'Pro / Standard', zynovexa: '$19/mo — 10 accounts, 500 AI, analytics', competitor: '$249/mo per seat — 5 profiles' },
  { plan: 'Business / Professional', zynovexa: '$49/mo — 25 accounts, unlimited AI, teams', competitor: '$399/mo per seat — unlimited profiles' },
];
