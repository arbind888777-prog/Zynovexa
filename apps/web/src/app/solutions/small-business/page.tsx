    ...
    <MarketingLayout>
      ...
      <section className="py-16 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <div className="card p-8 sm:p-12" style={{ border: '1px solid rgba(99,102,241,0.3)', background: 'rgba(99,102,241,0.05)' }}>
            <h2 className="text-3xl font-extrabold text-white mb-8 text-center">The math is simple</h2>
            <div className="grid sm:grid-cols-3 gap-6 text-center">
              {[
                { before: '$2,500/mo', label: 'Freelance Social Manager', after: '$29/mo', saving: 'Save $2,471' },
