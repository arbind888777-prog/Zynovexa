    ...
    <MarketingLayout>
      <section className="pt-28 sm:pt-36 pb-16 px-4 sm:px-6 text-center relative">
        ...
        <div className="max-w-4xl mx-auto relative marketing-hero-panel">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8 text-xs sm:text-sm">
            <span className="marketing-logo-pill">Hooks, captions, and scripts in one flow</span>
            <span className="marketing-logo-pill">Schedule once, distribute everywhere</span>
            <span className="marketing-logo-pill">Analytics tied to monetization</span>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="marketing-grid-shell grid sm:grid-cols-2 gap-5">
            {[
      ...
      <section className="py-16 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="marketing-grid-shell grid sm:grid-cols-3 gap-5">
            {[
